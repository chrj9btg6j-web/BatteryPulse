...
For example: `BatteryPulse.TopBar-v2.2.1-20260813.exe`.
...
powershell -ExecutionPolicy Bypass -File .\build\package-release.ps1 -Version 2.2.1 -Date 2026-08-13 -InstallerPath '.\dist\current\installer\BatteryPulse-Setup-v2.2.1-20260813.exe'
```
