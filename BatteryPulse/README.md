...
For example: `BatteryPulse.TopBar-v2.2.0-20260812.exe`.
...
powershell -ExecutionPolicy Bypass -File .\build\package-release.ps1 -Version 2.2.0 -Date 2026-08-12 -InstallerPath '.\dist\current\installer\BatteryPulse-Setup-v2.2.0-20260812.exe'
```
