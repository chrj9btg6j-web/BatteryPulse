...
For example: `BatteryPulse.TopBar-v2.2.4-20260814.exe`.
...
powershell -ExecutionPolicy Bypass -File .\build\package-release.ps1 -Version 2.2.4 -Date 2026-08-14 -BuildDir '.\dist\current' -InstallerPath '.\dist\current\installer\BatteryPulse-Setup-v2.2.4-20260814.exe' -UpdateNotePath '.\docs\updates\2026\2026-08-14.md'
```
