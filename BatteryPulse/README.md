...
For example: `BatteryPulse.TopBar-v2.2.3-20260813.exe`.
...
powershell -ExecutionPolicy Bypass -File .\build\package-release.ps1 -Version 2.2.3 -Date 2026-08-13 -BuildDir '.\dist\staging-2.2.3' -InstallerPath '.\dist\current\installer\BatteryPulse-Setup-v2.2.3-20260813.exe' -UpdateNotePath '.\docs\updates\2026\2026-08-13-power-layout.md'
```
